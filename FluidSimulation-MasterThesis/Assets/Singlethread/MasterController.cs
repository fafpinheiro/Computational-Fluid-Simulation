...
public class MasterController : MonoBehaviour
{
    ...
    [Header("If optimization with n/2 or Monte Carlo choose extension:")]
    public bool symmetryOptimization;
    ...
    [Header("Choose the scene.")]
    public MapSample mapSample;
    ...
    private void setMapSample()
    {
        GameObject scene;
       // Transform environment;
        switch (mapSample)
        {
            case MapSample.SimpleRoom: scene = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1").gameObject;
                scene.SetActive(true);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_4").gameObject.SetActive(false);
                GameObject.Find("CanvasMovingWalls").gameObject.SetActive(false);
                GameObject.Find("CanvasSpawnObj").gameObject.SetActive(false);
                spawn = scene.transform.Find("Spawn");
                environment = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1");
                cameraPosition = environment.Find("CameraPositions").transform;
                GameObject.Find("Main Camera").transform.position = environment.Find("Camera position").transform.position;
                GameObject.Find("Main Camera").transform.rotation = environment.Find("Camera position").transform.rotation;
                break;

            case MapSample.Ramp:
                scene = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2").gameObject;
                scene.SetActive(true);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_4").gameObject.SetActive(false);
                GameObject.Find("CanvasMovingWalls").gameObject.SetActive(false);
                GameObject.Find("CanvasSpawnObj").gameObject.SetActive(false);
                spawn = scene.transform.Find("Spawn");
                environment = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2");
                cameraPosition = environment.Find("CameraPositions").transform;
                GameObject.Find("Main Camera").transform.position = environment.Find("Camera position").transform.position;
                GameObject.Find("Main Camera").transform.rotation = environment.Find("Camera position").transform.rotation;
                break;
            case MapSample.MovingWalls:
                scene = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3").gameObject;
                scene.SetActive(true);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_4").gameObject.SetActive(false);
                GameObject.Find("CanvasMovingWalls").gameObject.SetActive(true);
                GameObject.Find("CanvasSpawnObj").gameObject.SetActive(false);
                spawn = scene.transform.Find("Spawn");
                environment = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3");
                cameraPosition = environment.Find("CameraPositions").transform;
                GameObject.Find("Main Camera").transform.position = environment.Find("Camera position").transform.position;
                GameObject.Find("Main Camera").transform.rotation = environment.Find("Camera position").transform.rotation;
                break;
            case MapSample.WaveRoom:
                scene = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_4").gameObject;
                scene.SetActive(true);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3").gameObject.SetActive(false);
                GameObject.Find("CanvasMovingWalls").gameObject.SetActive(false);
                GameObject.Find("CanvasSpawnObj").gameObject.SetActive(true);
                spawn = scene.transform.Find("Spawn");
                environment = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_4");
                cameraPosition = environment.Find("CameraPositions").transform;
                GameObject.Find("Main Camera").transform.position = environment.Find("Camera position").transform.position;
                GameObject.Find("Main Camera").transform.rotation = environment.Find("Camera position").transform.rotation;
                break;
            case MapSample.MultiFluids:
                scene = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_6").gameObject;
                scene.SetActive(true);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_1").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_2").gameObject.SetActive(false);
                GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_3").gameObject.SetActive(false);
                ...
                GameObject.Find("CanvasSpawnObj").gameObject.SetActive(false);
                spawn = scene.transform.Find("Spawn");
                environment = GameObject.Find("Scenes").transform.Find("_ENVIRONMENT_6");
                cameraPosition = environment.Find("CameraPositions").transform;
                GameObject.Find("Main Camera").transform.position = environment.Find("Camera position").transform.position;
                GameObject.Find("Main Camera").transform.rotation = environment.Find("Camera position").transform.rotation;
                break;
     ...
     public void initIteration()
    {
        ...
        switch (optimization/*preset*/)
        {
            ...
            case Optimization.MonteCarlo:
                i = (Interface)gameObject.AddComponent<MonteCarloAlgo>();// (Interface)(new GameObject("SPHMethodMonteCarlo " + this.gameObject.name)).AddComponent<C>();
